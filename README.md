...
The plan is that this will eventually be an app that allows you to search youtube and spotify to create collaborative playlists that can be synchronized to play at the same time on any device with a browser.
